...
class MoodMotivationScreen extends StatelessWidget {
            ...
            children: [
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.psychology_outlined, size: 64, color: AppColors.sakura),
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Daily affirmations, mood tracking, and motivational content to brighten your day.',
