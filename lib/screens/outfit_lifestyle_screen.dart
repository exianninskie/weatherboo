...
class OutfitLifestyleScreen extends StatelessWidget {
            ...
            children: [
              Card(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Icon(Icons.checkroom_outlined, size: 64, color: AppColors.sakura),
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Get personalized outfit suggestions and lifestyle tips based on the weather.',
